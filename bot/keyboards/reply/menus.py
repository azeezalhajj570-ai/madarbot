...
from bot.config import AppKind
...
def groups_keyboard(
    groups: Page[dict], lang: str, include_tabs: bool = True
) -> ReplyKeyboardMarkup:
    rows: list[list[str]] = []
    if include_tabs:
        rows.extend(tab_rows(lang))
...
def categories_keyboard(
    categories: list[str], lang: str, include_tabs: bool = True
) -> ReplyKeyboardMarkup:
    rows: list[list[str]] = []
    if include_tabs:
        rows.extend(tab_rows(lang))
...
def plugins_menu_keyboard(
    plugin_states: dict[str, bool], lang: str, include_tabs: bool = True
) -> ReplyKeyboardMarkup:
    rows: list[list[str]] = []
    if include_tabs:
        rows.extend(tab_rows(lang))
...
def task_agent_keyboard(
    agent_labels: list[str], lang: str, include_tabs: bool = True
) -> ReplyKeyboardMarkup:
    rows: list[list[str]] = []
    if include_tabs:
        rows.extend(tab_rows(lang))
...
def task_group_keyboard(
    group_labels: Page[str], lang: str, include_tabs: bool = True
) -> ReplyKeyboardMarkup:
    rows: list[list[str]] = []
    if include_tabs:
        rows.extend(tab_rows(lang))
...
def task_delete_keyboard(
    task_labels: list[str], lang: str, include_tabs: bool = True
) -> ReplyKeyboardMarkup:
    rows: list[list[str]] = []
    if include_tabs:
        rows.extend(tab_rows(lang))
