...
class Settings(BaseSettings):
    ...
    openrouter_app_title: str = Field(default="MadarBot", alias="OPENROUTER_APP_TITLE")
    ...
    reconcile_poll_interval: int = Field(default=300, alias="RECONCILE_POLL_INTERVAL")
    pending_job_requeue_minutes: int = Field(default=5, alias="PENDING_JOB_REQUEUE_MINUTES")
