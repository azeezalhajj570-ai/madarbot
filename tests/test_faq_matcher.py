...
from bot.faq.matcher import DeterministicFAQMatcher, normalize_text
...
def test_exact_match():
    ...
    entries = [MockEntry(1, "متى يبدأ الدرس؟", "يبدأ الساعة 9 مساءً.")]
...
def test_keyword_match():
    matcher = DeterministicFAQMatcher()
    entries = [MockEntry(1, "موعد الدرس", "يبدأ الساعة 9 مساءً.", keywords=["درس", "موعد"])]
...
def test_no_match():
    matcher = DeterministicFAQMatcher()
    entries = [MockEntry(1, "موعد الدرس", "يبدأ الساعة 9 مساءً.")]
