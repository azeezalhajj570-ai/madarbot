    ...
    async with SessionLocal() as session:
        ...
        for g in groups:
            ...
            session.add_all(
                [
                    ...
                    GroupSetting(
                        group_id=mid, key="anti_spam", value={"enabled": True, "threshold": 0.7}
                    ),
                    GroupSetting(
                        group_id=mid,
                        key="summary_time",
                        value={"time": "21:00", "timezone": "Asia/Riyadh"},
                    ),
                    GroupSetting(
                        group_id=mid, key="welcome_message", value={"text": "اهلاً بك في المجموعة"}
                    ),
                ]
            )
            session.add_all(
                [
                    ...
                    PluginEnabled(
                        group_id=mid, plugin_name="faq", enabled=True, config={"safe_mode": True}
                    ),
                ]
            )
            session.add(
                ModerationSetting(
                    ...
                    mute_threshold=0.93,
                    ban_threshold=0.97,
                    action_for_arabic_ads="delete",
                    action_for_investment_scam="ban",
                    action_for_crypto_scam="ban",
                    action_for_phishing_link="ban",
                    action_for_link_spam="delete",
                    action_for_repeated_promo="mute",
            ...
            session.add(
                GroupSubscriptionSettings(
                    ...
                    auto_approve_manual_payments=False,
                    auto_remove_expired=True,
                    expiry_action="remove",
                    grace_period_days=7,
        ...
        session.add_all(
            [
                ModerationLog(
                    ...
                    target_user_id=555111222,
                    admin_user_id=6816159624,
                    reason="إعلان غير مرخص",
                ...
                ModerationLog(
                    ...
                    target_user_id=555111222,
                    admin_user_id=6816159624,
                    reason="نصب استثماري - تكرار المخالفات",
                ...
                ModerationLog(
                    group_id=g1.id,
                    action="warn_user",
                    target_user_id=888444555,
                    admin_user_id=6816159624,
                    reason="ترويج متكرر - إنذار أول",
                ...
                ModerationLog(
                    ...
                    admin_user_id=6816159624,
                    reason="موافقة على طلب الانضمام",
                ...
                ModerationLog(
                    group_id=g1.id,
                    action="mute_user",
                    target_user_id=777333444,
                    admin_user_id=6816159624,
                    reason="إرسال روابط مشبوهة - كتم لمدة ساعتين",
        ...
        session.add_all(
            [
                ...
                GroupMember(
                    group_id=g1.id,
                    tg_user_id=555111222,
                    username="spam_user1",
                    full_name="مستخدم مزعج",
                    role="member",
                    source="direct_add",
                ),
                GroupMember(
                    group_id=g1.id,
                    tg_user_id=888444555,
                    username="promo_user",
                    full_name="مستخدم ترويجي",
                    role="member",
                    source="direct_add",
                ),
            ]
        ...
        session.add(
            SubscriptionRequest(
                ...
                username="new_user",
                full_name="عمر الجديد",
                language_code="ar",
                message="أريد الانضمام للمجموعة",
                status="pending",
                plan="pro",
            )
        )
